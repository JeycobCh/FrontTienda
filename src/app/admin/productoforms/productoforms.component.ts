...
@Component({
  selector: 'app-productoforms',
  templateUrl: './productoforms.component.html',
  styleUrls: ['./productoforms.component.scss']
})
export class ProductoformsComponent implements OnInit {
